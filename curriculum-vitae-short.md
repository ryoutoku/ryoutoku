...
| 技術スタック | AWS ( IAM / ECR / RDS / S3 )<br>Ruby (Ruby on Rails)<br>Vue.js<br>Git / Github |
...
リードの Web エンジニアとして Join し、コードレビュー等を実施。自身の知見を社内ナレッジツールに積極的に UP し、技術の共有を行なっている。面接官として採用活動に従事。
...
|     役割     | メンバー                                                                                                                                             |
|     担当     | Backend<br>Frontend                                                                                                                                  |
| 技術スタック | AWS ( IAM / ECR / RDS / S3 / Lambda / CloudHSM / CodePipeline / CloudWatch )<br>Python ( Django / REST Framework )<br>Java<br>Vue.js<br>Git / Github |
|   業務内容   | 既存コードの保守、新規機能開発(REST API 設計など) <br>Java, Lambda, CloudHSM を用いた電子署名ロジックの実装<br>採用面接官                            |
...
| 技術スタック | AWS ( EKS / IAM / ECR / RDS / S3 )<br>Terraform<br>Helm<br>Python ( Django / REST Framework / Pyspark / pandas / scikit-learn / boto3 )<br>Airflow<br>Git / Github                                                                                                           |
...
|     役割     | メンバー                                               |
|     担当     | Backend                                                |
| 技術スタック | groovy ( Grails )<br>Python ( Django )<br>Git / Github |
