...
|     C#     | 2009-2015 |                       WPF                        | Windows クライアントアプリ保守開発で使用<      |
|  C / C++   | 2009-2015 |                  Windows Froms                   | 外部ハードのエミュレータアプリ保守開発で使用   |
|    Ruby    | 2015-2016 |                        -                         | Jenkins 用のファイル変換等で使用               |
|  C / C++   |   2017    |                 OpenCL / OpenGL                  | 動画処理の高速化検証で使用                     |
|   Python   |   2017-   | Pyspark / pandas / scikit-learn / Django / Flask | Web アプリや機械学習、ビッグデータ処理等で使用 |
| TypeScript | 2019-2020 |                      Vue.js                      | 個人作成した Web アプリで使用                  |
| JavaScript |   2021-   |                      Vue.js                      | Web アプリの保守開発で仕様                     |
...
|     Django     |   2017-   | Web アプリケーションの開発で使用<br>REST Framework を使い、アーキテクチャを 0 から考え REST API を実装することが可能                                                                  |
...
面接官として採用活動に従事。が、採用面接っぽくない面接をしてしまっている。これでいいのかと模索中。
