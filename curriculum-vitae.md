...
|   業務内容   | CEO と共にプロダクトの方向性を検討<br>顧客へのプレゼン資料の作成、レビュー、ミーティングの実施<br>Pyspark、pandas を用いたビッグデータのデータ分析<br>データフローの設計、実装、リファクタリングによる改善<br>REST API 設計、実装、リファクタリングによる改善<br>k8s(Helm)の設計、実装 |
